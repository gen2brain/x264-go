...
#cgo linux,!android,arm64 CFLAGS: -DSYS_LINUX=1 -DARCH_AARCH64=1 -DHAVE_POSIXTHREAD=1 -DSTACK_ALIGNMENT=16 -DHAVE_MALLOC_H=1 -DHAVE_CPU_COUNT=1 -DTHP=1 -DARCH_AARCH64=0
